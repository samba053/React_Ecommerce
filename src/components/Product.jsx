...
function Product() {
    ...
    return ( 
        ...
        <div>
            <h2 className='bg-gray-500 text-white text-2xl p-2 text-center my-2'>Selected Products</h2>
            <div className="w-1/4 mx-auto bg-white rounded-lg shadow-md overflow-hidden">
                <img src={selectedProduct.imgSrc} alt="Apple iPhone 15" className="h-64 mx-auto" />
                <div className="p-4">
                    <h2 className="text-xl font-semibold text-gray-800 cursor-pointer">{selectedProduct.name}</h2>
                    ...
                    <ul className="mt-2 text-gray-600 text-sm space-y-1">
                        {selectedProduct.specifications && selectedProduct.specifications.map((specification, index) => (
